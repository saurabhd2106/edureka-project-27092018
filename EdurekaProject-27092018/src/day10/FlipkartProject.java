...
public class FlipkartProject {
	...
	public void getUrlFromLink() {
		WebElement loginAndSignupFlipkart = driver.findElement(By.linkText("Login & Signup"));

		String url = loginAndSignupFlipkart.getAttribute("href");

		System.out.println("Url of the link : " + url);
	}

	public void printCountOfNumberOfLinksOnFlipkart() {
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));

		System.out.println(allLinks.size());
	}

	public void printUrlFromAllLinksOnFlipkart() {
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
